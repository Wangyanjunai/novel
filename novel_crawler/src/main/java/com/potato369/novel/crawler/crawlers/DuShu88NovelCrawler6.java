 ...
 * </pre>
 */
@Crawler(name = "88dush6", useUnrepeated = true) 
@Slf4j
public class DuShu88NovelCrawler6 extends BaseSeimiCrawler{
...
//            List<Object> urlList = document.sel("//body/div[@class='tuijian']/ul/li/h2/a/@href");
            ...
            BusinessConstants.threadPoolStart.execute(()-> {
	            ...
	            for (Object url:urlList) {
	                ...
	                push(Request.build(BusinessConstants.CURRENT_START_URL, DuShu88NovelCrawler6::getEachPage));
	                //当前线程等待直到被唤醒
	                try {
        ...
        try {
            ...
            BusinessConstants.threadPoolPage.execute(()-> {
                ...
                for (Object url:urlList) {
                    ...
                    push(Request.build(BusinessConstants.CURRENT_GET_DATA_URL, DuShu88NovelCrawler6::getEachBook));
                    try {
                        Thread.sleep(5000);
                    } catch (InterruptedException e) {
        ...
        try {
            ...
            BusinessConstants.threadPoolBook.execute(()-> {
                ...
                for (Object url:urlList) {
                    ...
                    push(Request.build(BusinessConstants.CURRENT_GET_BOOK_DATA_URL, DuShu88NovelCrawler6::renderChapterBean));
