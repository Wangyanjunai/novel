...
/**
 * <pre>
 * 类名：BiXiaWenXue9NovelCrawler
 * 类的作用：爬取笔下文学小说网站内容 https://www.bxwx9.org
 * 创建原因：
 ...
 * </pre>
 */
@Crawler(name = "bxwx", useUnrepeated = false)
@Slf4j
public class BiXiaWenXueNovelCrawler extends BaseSeimiCrawler{

	private static final long serialVersionUID = -6000214532002090859L;
		
	@Override
	public String[] startUrls() {
		return new String[]{"https://www.bxwx9.org"};
	}
