 ...
 * <pre>
 * 类名: HotNovelCrawler
 * 类的作用:爬取新顶点小说网站内容 https://www.23us.la
 * 创建原因:
 ...
 * </pre>
 */
@Crawler(name = "23us", useUnrepeated = false)
@Slf4j
public class NewDinDianNovelCrawler extends BaseSeimiCrawler{

	private static final long serialVersionUID = -6000214532002090859L;
		
	@Override
	public String[] startUrls() {
		return new String[]{"https://www.23us.la"};
	}
