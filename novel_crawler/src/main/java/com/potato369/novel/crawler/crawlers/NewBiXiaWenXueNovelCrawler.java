 ...
 * <pre>
 * 类名: HotNovelCrawler
 * 类的作用:爬取新笔下文学小说网站内容 http://www.xbxwx.net
 * 创建原因:
 ...
 * </pre>
 */
@Crawler(name = "xbxwx", useUnrepeated = false)
@Slf4j
public class NewBiXiaWenXueNovelCrawler extends BaseSeimiCrawler{

	private static final long serialVersionUID = -6000214532002090859L;
		
	@Override
	public String[] startUrls() {
		return new String[]{"http://www.xbxwx.net"};
	}
