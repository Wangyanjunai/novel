...
/**
 * <pre>
 * 类名: ZhuiShuShenQiNovelCrawler
 * 类的作用:爬取追书神器小说网站内容 https://www.zhuishushenqi.com
 * 创建原因:
 ...
 * </pre>
 */
@Crawler(name = "zhuishushenqi", useUnrepeated = false)
@Slf4j
public class ZhuiShuShenQiNovelCrawler extends BaseSeimiCrawler{

	private static final long serialVersionUID = -6000214532002090859L;
		
	@Override
	public String[] startUrls() {
		return new String[]{"https://www.zhuishushenqi.com"};
	}
