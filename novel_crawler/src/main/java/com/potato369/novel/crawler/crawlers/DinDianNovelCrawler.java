...
/**
 * <pre>
 * 类名： DinDianNovelCrawler
 * 类的作用：爬取顶点小说网站内容 http://www.dindian.net
 * 创建原因：
 ...
 * </pre>
 */
@Crawler(name = "dindian", useUnrepeated = false)
@Slf4j
public class DinDianNovelCrawler extends BaseSeimiCrawler{

	private static final long serialVersionUID = -6000214532002090859L;
		
	@Override
	public String[] startUrls() {
		return new String[]{"http://www.dindian.net"};
	}
