                ...
                <#--订单数据-->
                    ...
                    <div class="col-md-12 column">
                        <#if orderDTO.getOrderStatusEnum().code == 0>
                            <a type="button" class="btn btn-primary btn-default active" href="/novel/order/finish?orderId=${orderDTO.orderId}">完结订单</a>
                            <a type="button" class="btn btn-default active btn-danger" href="/novel/order/cancel?orderId=${orderDTO.orderId}">取消订单</a>
                        </#if>
                    </div>
                </div>
            </div>
