...
-- ----------------------------
-- 【1】 Table structure for novel_category
-- ----------------------------
...
CREATE TABLE `novel_category` (
  ...
  `category_zh_name` varchar(64) NULL DEFAULT NULL COMMENT '中文名称',
  `category_en_name` varchar(64) DEFAULT NULL COMMENT '英文名称',
...
-- ----------------------------
-- 【2】Table structure for novel_info
-- ----------------------------
...
-- ----------------------------
-- 【3】Table structure for novel_chapter
-- ----------------------------
...
-- ----------------------------
-- 【4】Table structure for novel_user_info
-- ----------------------------
...
-- ----------------------------
-- 【5】 Table structure for novel_advertisement
-- ----------------------------
...
CREATE TABLE `novel_advertisement` (
  ...
  `image_url` varchar(1256) DEFAULT NULL COMMENT '广告图片链接地址。',
  `link_url` varchar(1256) DEFAULT NULL COMMENT '广告跳转链接地址。',
...
-- ----------------------------
-- 【6】Table structure for order_detail
-- ----------------------------
...
-- ----------------------------
-- 【7】Table structure for order_master
-- ----------------------------
...
-- ----------------------------
-- 【8】Table structure for product_info
-- ----------------------------
...
CREATE TABLE `product_info` (
  ...
  `product_price` decimal(8, 2) unsigned NOT NULL COMMENT '书币产品单价（元）',
  `product_quantity` decimal(8, 0) DEFAULT NULL COMMENT '书币产品数量',
  `product_amount` decimal(8, 2) DEFAULT NULL COMMENT '产品总价（元）',
...
-- ----------------------------
-- 【9】Table structure for seller_info
-- ----------------------------
...
-- ----------------------------
-- 【10】 Table structure for novel_shelf
-- ----------------------------
...
-- ----------------------------
-- 【11】 Table structure for novel_comment
-- ----------------------------
...
CREATE TABLE `novel_comment` (
  ...
  `chapter_id` varchar(32) NULL DEFAULT NULL COMMENT '章节id',
  `comment_title` varchar(256) DEFAULT NULL COMMENT '评论标题。',
  `comment_content` varchar(2048) DEFAULT NULL COMMENT '评论内容。',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
-- ----------------------------
-- 【12】Table structure for novel_menu_info
-- ----------------------------
...
CREATE TABLE `novel_menu_info` (
  ...
  `url` varchar(256) DEFAULT NULL COMMENT '网页链接，用户点击菜单可打开链接，不超过1024字节。type为miniprogram时，不支持小程序的老版本客户端将打开本url。view、miniprogram类型必须。',
  ...
  `page_path` varchar(256) DEFAULT NULL COMMENT '小程序的页面路径，miniprogram类型必须。',
  `create_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
