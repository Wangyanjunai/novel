...
CREATE TABLE `novel_info` (
  ...
  `data_url` varchar(1024) NULL DEFAULT NULL COMMENT '数据爬取的服务器URL',
...
CREATE TABLE `novel_shelf_detail`  (
   ...
   `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户id，联合主键。',
   `last_read_chapter_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '最后一次阅读的章节的id(可能为空)。',
